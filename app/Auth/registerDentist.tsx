...
import { FormDataDentistRegister } from "../utils/types";

const RegisterDentist: React.FC = () => {
  const { control, handleSubmit, formState: { errors }, reset } = useForm<FormDataDentistRegister>();
  ...
  // Función de envío
  const onSubmit = async (data: FormDataDentistRegister) => {
    try {
